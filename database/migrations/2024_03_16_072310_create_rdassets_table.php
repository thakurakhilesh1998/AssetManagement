...
return new class extends Migration
{
    ...
    {
        Schema::create('rdassets', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('owner',['Department of Rural Development','DRDA']);
