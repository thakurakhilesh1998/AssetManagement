...
<div class="container-fluid">
    ...
    <div class="container text-black">
        ...
        @endif
        <div class="card p-3">
        <form method="POST" action="{{url('bdo/edit-assetpr').'/'.$prdata->id}}" id="editAsset" name="editAsset"  enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="mb-3" id="blocks-block">
                <label for="Block Name">Name of Block</label>
                <input type="text" value="{{$block}}" name="blocklist" readonly class="form-control">
            </div>
            <div class="mb-3">
